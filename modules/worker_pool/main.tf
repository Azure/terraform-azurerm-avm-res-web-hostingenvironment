# Worker Pool submodule for App Service Environment
# Note: This is primarily used for ASEv1/v2. ASEv3 manages worker pools internally.
resource "azapi_resource" "this" {
  name      = var.name
  parent_id = var.hosting_environment_id
  type      = "Microsoft.Web/hostingEnvironments/workerPools@2024-04-01"
  body = {
    kind = var.kind
    properties = {
